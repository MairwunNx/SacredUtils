...
namespace SacredUtils.Resources.bin
{
    public class AncillaryConstsStrings
    {
        ...
        public const string AppReleaseVersion = "1.2R Rv4 B7 (200618)";

        public const string AppAlphaVersion = "1.2R Rv4 B7 (200618)";

        public const string AppColorValue = "User interface color SacredUtils";

        public const string AppCurrentVersion = "1.2R Rv4 B7 (200618)";
