    ...
    public partial class MainWindow
    {
        ...
        public void RandomChangeExampleText()
        {
            ...
            string[] randomStrings =
            {
                ...
                "Работает? - не трогай!",
                "Physics is power!",
                "Сраная парикмахерша (с) Карл Лысый",
                "Этой цитатой был я (с) Альберт Эйнштейн",
                "Блин, кроссы неудобные купил, пятку натирают (с) Ахиллес",
                "Авп мид (с) Джон Кенеди",
                "Мы вам перезвоним (c) Лжедмитрий I",
                "Не выплатишь кредит, придет к тебе бандит (c) Тинькофф банк",
                "Почему в школу в джинсах нельзя? (c) Леви Штраус",
                "ctrl+c ctrl+v (c) овечка Долли",
                "ctrl+c ctrl+v (c) Dolly the sheep",
                "В смысле с грибами нет? Ну ладно давайте говяжий (c) Александр Сергеевич Грибоедов",
                "Че, жидкость для розжига забыли? Ладно, у меня кое-что есть (c) Николай Гоголь",
                "Миша, ты чертежи от моего Stg-44 случайно не видел? (c) Хуго Шмайссер",
                "Стихи про мамку друга не дорого (c) Сергей Есенин",
                "Кто сука свет выключил? (c) Василий Тёмный",
                "Покупайте новый липтон в пирамидках (c) Сергей Мавроди",
                "Пацаны взломаю платное гдз на раз два (c) Эдвард Сноуден",
                "Сгорел сарай - гори и хата (c) Михаил Кутузов",
                "Пацаны как вам дуб (c) Лев Толстой",
                "Щя открою банку варенья. (с) Август Сильный",
                "Я бью два раза: один - по Хиросиме, другой - по Нагасаки. (c) Гарри Трумэн",
                "Блин саня мы походу не на тот троллейбус сели (c) Христофор Колумб",
                "Слыш ты как меня назвал? (c) Пьер Гандон",
                "Да не буду я письки статуям увеличивать!!! (c) Микеланджело",
                "Парни, мне кажется или мы ходим по кругу (c) Фернан Магеллан",
                ...
                "Любите слалом, бобслей, прыжки с трамплина? — тогда вам точно не сюда, здесь можно побиатлонить с ледяными гоблинами, сократить популяцию местных гигантов, ну и побеседовать с очередным драконом :-).",
                "Не стоит тратить время на кучки орков, тебе ведь не помешает хорошая лошадка, абсолютно бесплатно,между прочим!",
                "Гоблин-биатлон, йети-сафари, дракон на десерт :-)"
            };
